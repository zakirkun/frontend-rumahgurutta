<template>
    <div class="pb-20 pt-20">
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <!-- categoryHome -->
            <CategoryHome />
            <div class="mt-5 gap-4 md:gap-4 bg-white rounded-md shadow-md">
                <img src="@/assets/images/megaphone.png" class="h-10 w-10 inline-block m-2"/>
                <span class="text-lg inline-block p-3">Daftar Penggalangan Dana</span>
            </div>
